...
Uses Pandoc via ``subprocess`` to convert plain text documents into EPUB.
...
class TxtToEpubConverter(BaseConverter):
    """Convert TXT documents to EPUB using Pandoc."""
    ...
    def convert(self, input_file: str, output_file: str) -> str:
        """
        Run Pandoc to convert *input_file* (plain text) into EPUB.
        """
