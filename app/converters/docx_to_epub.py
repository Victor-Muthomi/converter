...
Uses Pandoc via ``subprocess`` to convert Word documents into EPUB.
...
class DocxToEpubConverter(BaseConverter):
    """Convert DOCX documents to EPUB using Pandoc."""
    ...
    def convert(self, input_file: str, output_file: str) -> str:
        """
        Run Pandoc to convert *input_file* (DOCX) into EPUB.
        """
