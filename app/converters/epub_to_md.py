...
Uses Pandoc via ``subprocess`` to convert EPUB documents into Markdown.
...
class EpubToMarkdownConverter(BaseConverter):
    """Convert EPUB documents to Markdown using Pandoc."""
    ...
    def convert(self, input_file: str, output_file: str) -> str:
        """
        Run Pandoc to convert *input_file* (EPUB) into Markdown.
        """
