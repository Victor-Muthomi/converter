...
Uses Pandoc via ``subprocess`` to convert EPUB documents into HTML.
...
class EpubToHtmlConverter(BaseConverter):
    """Convert EPUB documents to HTML using Pandoc."""
    ...
    def convert(self, input_file: str, output_file: str) -> str:
        """
        Run Pandoc to convert *input_file* (EPUB) into HTML.
        """
