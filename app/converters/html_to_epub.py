...
Uses Pandoc via ``subprocess`` to convert HTML documents into EPUB.
...
class HtmlToEpubConverter(BaseConverter):
    """Convert HTML documents to EPUB using Pandoc."""
    ...
    def convert(self, input_file: str, output_file: str) -> str:
        """
        Run Pandoc to convert *input_file* (HTML) into EPUB.
        """
